...
const FAQ_ITEMS = {
  "Tengo una pregunta": "sts",
  "Ayuda": "help",
  "¿Por qué no va nada?": "why nothing works",
  "¿Qué puedo hacer con...?": "What can I do with...?",
  "Soy admin": "I am admin",
};
    ...
    <>
      <Layout>
        <div className="flex flex-wrap gap-4 pt-20 px-10 pb-5">
          ...
          <div className="flex flex-1 flex-col gap-4 sticky top-20 h-fit">
          ...
          {/* Columna derecha: FAQ */}
          <div className="flex flex-10 flex-col gap-5 py-5 px-6 min-w-125 bg-gray-700 rounded-2xl">
